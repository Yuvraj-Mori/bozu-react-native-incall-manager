...
public class AppRTCBluetoothManager {
  ...
  private class BluetoothServiceListener implements BluetoothProfile.ServiceListener {
    ...
    public void onServiceDisconnected(int profile) {
      if (profile != BluetoothProfile.HEADSET || bluetoothState == State.UNINITIALIZED) {
        Log.d(TAG, "BluetoothServiceListener.onServiceDisconnected: returning: profile: " + profile + " btstate: "
            + bluetoothState);
        return;
      }
      ...
      updateAudioDeviceState("service-disconn");
  ...
  private class BluetoothAudioDeviceCallback extends AudioDeviceCallback {
    ...
    public void onAudioDevicesAdded(AudioDeviceInfo[] addedDevices) {
      if (bluetoothAudioDevice != null) {
        for (int i = 0; i < addedDevices.length; i++) {
          if (addedDevices[i].getId() == bluetoothAudioDevice.getId()) {
    ...
    public void onAudioDevicesRemoved(AudioDeviceInfo[] removedDevices) {
      if (bluetoothAudioDevice != null) {
        for (int i = 0; i < removedDevices.length; i++) {
          if (removedDevices[i].getId() == bluetoothAudioDevice.getId()) {
            // stopScoAudio();
            bluetoothState = State.HEADSET_UNAVAILABLE;
          }
        }
    ...
    private void updateDeviceList() {
      ...
      if (bluetoothAudioDevice != null && newBtDevice == null) {
        ...
        Log.d(TAG,
            "updateDeviceList after onAudioDevicesRemoved newbtdevice: " + newBtDevice);
      } else {
        Log.d(TAG, "updateDeviceList after onAudioDevicesRemoved newbtdevice is null ");
      }
      if (needChange) {
        updateAudioDeviceState("update-device-list");
      }
    }
  }
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      if (action.equals(BluetoothHeadset.ACTION_CONNECTION_STATE_CHANGED)) {
        ...
        if (state == BluetoothHeadset.STATE_CONNECTED) {
          ...
          updateAudioDeviceState("onreceive-if-conn");
          ...
          stopScoAudio();
          updateAudioDeviceState("onreceive-if-disconn");
        }
        ...
        if (state == BluetoothHeadset.STATE_AUDIO_CONNECTED) {
          ...
          if (bluetoothState == State.SCO_CONNECTING) {
            ...
            scoConnectionAttempts = 0;
            updateAudioDeviceState("onreceive-elseif-audio-conn");
          } else {
          ...
          updateAudioDeviceState("onreceive-elseif-audio-disconn");
        }
      }
  ...
  public void start() {
    ThreadUtils.checkIsOnMainThread();
    Log.d(TAG, "start");
    String p = Build.VERSION.SDK_INT >= Build.VERSION_CODES.S ? android.Manifest.permission.BLUETOOTH_CONNECT
  ...
  public boolean startScoAudio() {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
      ...
      updateAudioDeviceState("startsco");
    } else {
   ...
   */
  private void updateAudioDeviceState(String via) {
    ThreadUtils.checkIsOnMainThread();
    Log.d(TAG, "updateAudioDeviceState" + via);
  ...
  private void bluetoothTimeout() {
    ...
    updateAudioDeviceState("bluetooth_timer");
  ...
  private boolean isScoOn() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
      ...
      return communicationDevice != null && bluetoothAudioDevice != null
          && communicationDevice.getId() == bluetoothAudioDevice.getId();
    } else {
